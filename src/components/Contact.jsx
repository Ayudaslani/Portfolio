...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch("https://script.google.com/macros/s/AKfycbwbW9zxg_tgM7DQ228kj1Tz0yYr-9jjM7atD2y1WGTfZzV1uPoAPCOtA10258mXKGMzgQ/exec", {
        method: "POST",
        ...
        <div style={contentGrid} className="contact-content-grid">
          ...
          >
            ...
            <div style={infoGroup}>
              <div style={infoItem}>
                <span style={infoLabel}>Email</span>
                <a href="mailto:ayushidaslani@example.com" style={infoValue}>
                  ayushidaslani@example.com
                </a>
              </div>
            </div>
          </motion.div>
          ...
          {/* Right Side Form */}
          <div style={rightSide}>
            <form style={form} className="contact-form" onSubmit={handleSubmit}>
